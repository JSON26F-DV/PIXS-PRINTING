 ...
 */
const VariantSelector: React.FC<VariantSelectorProps> = ({ variants, selectedVariantId, onSelect, minThreshold, compatibleVariantSizes }) => {
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        {variants.map(v => {
          ...
          const isCompatible = !compatibleVariantSizes || compatibleVariantSizes.includes(v.size);
          ...
          return (
            <button
              ...
              className={clsx(
                ...
                isDisabled ? 'opacity-40 grayscale cursor-not-allowed border-dashed' : ''
              )}
            >
              ...
              {!isCompatible && !isOutOfStock && (
                 <span className="text-[7px] font-black uppercase tracking-widest text-slate-400 mt-1">Plate Incompatible</span>
              )}
