...
const StatCard: React.FC<StatCardProps> = ({ title, value, prefix = "", suffix = "", trend, icon: Icon, className, variant = 'light' }) => {
  ...
  return (
    <div className={cn("p-6 relative group overflow-hidden rounded-[24px] transition-all hover:-translate-y-1", bgClass, className)}>
      ...
      <div className="flex items-baseline gap-1 relative z-10">
        <span className={cn("text-2xl font-bold", prefixColor)}>{prefix}</span>
