    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[1000] flex items-start justify-end bg-slate-900/60 backdrop-blur-md sm:p-6 md:pt-24"
          onClick={safeClose}
        ...
        >
          ...
          >
            ...
            {/* Body */}
            <div className="custom-scrollbar flex-1 space-y-4 overflow-y-auto overscroll-contain p-6">
              {notifications.length === 0 ? (
