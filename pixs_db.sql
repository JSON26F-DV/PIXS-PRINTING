...
--
-- Host: localhost
-- Generation Time: Apr 11, 2026 at 03:51 PM
...
-- --------------------------------------------------------
-- ============================================================
-- PIXS DB — FULL DATABASE DUMP
-- Charset: utf8mb4 / utf8mb4_unicode_ci (ALL tables)
-- Passwords: bcrypt via Hash::make('password123')
-- MariaDB 10.4.32 | Generated: 2026-04-12
-- ============================================================
...
-- DATABASE
-- ============================================================
CREATE DATABASE IF NOT EXISTS `pixs_db`
...
CREATE TABLE `cart_items` (
  ...
  `variant_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `screenplate_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- ============================================================
-- TABLE: cart_item_colors
-- ============================================================
CREATE TABLE `cart_item_colors` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `cart_item_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `color_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `channel_label` enum('Primary','Secondary','Accent') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Primary',
...
INSERT INTO `cart_item_colors` VALUES
(1,'P001__V-PPY-12OZ__C001__SP-S-001','C001','Primary',0),
(2,'P001__V-PPY-12OZ__C001__SP-S-001','C002','Secondary',1);
...
CREATE TABLE `colors` (
  ...
  `type` enum('Standard','Premium') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Standard',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `conversations` (
  ...
  `last_message_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `conversation_participants` (
  ...
  `participant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `participant_type` enum('employee','customer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ============================================================
-- TABLE: customers
-- password = bcrypt of 'password123'
-- ============================================================
...
('addr_002','CUST-501','Corporate Branch A','+63 900 000 0000','Region IV-A','Laguna','Binan','San Pedro','Industrial Ave','Industrial Ave, Binan, Laguna','4024',1,14.3333000,121.0833000);

-- ============================================================
-- TABLE: customer_contact_numbers
-- ============================================================
...
INSERT INTO `customer_contact_numbers` VALUES
...
CREATE TABLE `customer_discounts` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `customer_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `discount_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('unit','percentage','fixed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `customer_discounts` VALUES
...
CREATE TABLE `customer_payment_methods` (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('bank','ewallet','credit_card','cod') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `bank_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `masked_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_default` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `customer_id` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `deleted_accounts` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `original_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_type` enum('employee','customer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `deleted_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `deleted_by_type` enum('employee','customer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'employee',
...
CREATE TABLE `employees` (
  ...
  `profile_picture` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `role` enum('admin','staff','technician','welder','inventory') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('active','inactive') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `age` tinyint(3) UNSIGNED DEFAULT NULL,
  `gender` enum('male','female','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
('EMP-001','Jason','G','https://i.pravatar.cc/300?img=11','jason@pixs.com','admin','active',28,'male','PIXS PRINTING SHOP','$2y$12$6pX90R7u0.9TInXzGPmGuev6MvE.C1uXyX8v7.nF9t/K9.uH.yM2e',0.00,850.00,150.00,'2024-01-15 08:00:00','2026-03-28 10:30:00'),
...
CREATE TABLE `employee_attendance` (
  ...
  `employee_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  `status` enum('full','half','absent') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'full',
...
-- ============================================================
-- TABLE: employee_contact_numbers
-- ============================================================
...
INSERT INTO `employee_contact_numbers` VALUES
...
INSERT INTO `employee_weekly_salary` VALUES
...
CREATE TABLE `inventory_logs` (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `employee_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty_added` int(11) NOT NULL DEFAULT 0,
  `cost` decimal(12,2) NOT NULL DEFAULT 0.00,
  `type` enum('RESTOCK','MISC','ADJUSTMENT','DAMAGE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RESTOCK',
...
-- ============================================================
-- TABLE: marketing_promotions
-- ============================================================
CREATE TABLE `marketing_promotions` (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `discount_type` enum('percentage','unit') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `discount_value` decimal(10,2) NOT NULL,
  `target_type` enum('all_users','specific_user') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `assigned_user_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `marketing_promotions` VALUES
...
CREATE TABLE `messages` (
  ...
  `sender_type` enum('employee','customer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiver_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiver_type` enum('employee','customer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reply_to_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_edited` tinyint(1) NOT NULL DEFAULT 0,
  `original_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `message_attachments` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `message_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- emoji column MUST be utf8mb4 for 4-byte emoji support
-- ============================================================
CREATE TABLE `message_reactions` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `message_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_type` enum('employee','customer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `orders` (
  `id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `discount_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `complaint` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rating` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `admin_comment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `customer_id` (`customer_id`)
...
CREATE TABLE `order_items` (
  ...
  `product_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `variant_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `screenplate_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `custom_requirements` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `products` (
  `id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `short_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `long_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `best_for` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `print_method` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1,'P001','Budget-Friendly'),(2,'P001','Food Grade'),(3,'P001','High Volume'),
(4,'P002','Premium Look'),(5,'P002','Food Grade'),(6,'P002','Crystal Clear'),
(7,'P003','Ergonomic'),(8,'P003','Food Grade'),(9,'P003','Modern Design'),
(10,'P004','Best Seller'),(11,'P004','Insulated'),(12,'P004','Includes Lid'),(13,'P004','Food Grade'),
(14,'P005','Eco-Friendly'),(15,'P005','Crystal Clear'),(16,'P005','BPA-Free'),(17,'P005','Recyclable'),
(18,'P006','Wide Mouth'),(19,'P006','BPA-Free'),(20,'P006','Recyclable'),(21,'P006','Crystal Clear'),
(22,'P007','Food Grade'),(23,'P007','Dome Top'),(24,'P007','Topping-Friendly'),
(25,'P008','Eco-Friendly'),(26,'P008','No Straw'),(27,'P008','Food Grade'),
(28,'P009','Food Grade'),(29,'P009','Minimal Design'),(30,'P009','Leak-Proof'),
(31,'P010','Unique'),(32,'P010','Double Cup'),(33,'P010','Takeaway-Friendly'),(34,'P010','Food Grade'),
(35,'P011','Food Grade'),(36,'P011','Black'),(37,'P011','Premium Look'),
(38,'P012','Eco-Friendly'),(39,'P012','Food Grade'),(40,'P012','Leak-Resistant'),(41,'P012','Hot Food Safe'),
(42,'P013','Food Grade'),(43,'P013','Hot & Cold Safe'),(44,'P013','Customizable'),(45,'P013','Eco-Friendly'),
(46,'P014','Food Grade'),(47,'P014','Leak-Resistant'),(48,'P014','Takeaway'),
(49,'P015','Food Grade'),(50,'P015','Clamshell'),(51,'P015','Grease-Resistant'),(52,'P015','Hot Food Safe'),
(53,'P016','Food Grade'),(54,'P016','Rice Meal'),(55,'P016','Grease-Resistant'),(56,'P016','Takeaway'),
(57,'P017','Food Grade'),(58,'P017','Tall Profile'),(59,'P017','Grease-Resistant'),(60,'P017','Catering'),
(61,'P018','Food Grade'),(62,'P018','Grease-Resistant'),(63,'P018','Heavy Duty'),(64,'P018','Takeaway'),
(65,'P019','Food Grade'),(66,'P019','2 Compartments'),(67,'P019','Grease-Resistant'),(68,'P019','Combo Meal'),
(69,'P020','Food Grade'),(70,'P020','Grease-Resistant'),(71,'P020','Street Food'),(72,'P020','Elongated');
...
CREATE TABLE `screenplates` (
  ...
  `plate_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `alignment` enum('Front','Back-to-Back','Triple Logo') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Front',
  `supported_alignments` set('Front','Back-to-Back','Triple Logo') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Front',
  `dimensions` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `technical_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `screenplates` VALUES
...
-- ============================================================
-- TABLE: screenplate_compatibility
-- ============================================================
CREATE TABLE `screenplate_compatibility` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `screenplate_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `variant_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `screenplate_compatibility` VALUES
...
-- ============================================================
-- TABLE: screenplate_incompatible
-- ============================================================
...
INSERT INTO `screenplate_incompatible` VALUES
...
CREATE TABLE `screenplate_requests` (
  ...
  `alignment` enum('Front','Back-to-Back','Triple Logo') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Front',
  `reference_image` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `cart_item_colors`
  ADD CONSTRAINT `cart_item_colors_ibfk_1` FOREIGN KEY (`cart_item_id`) REFERENCES `cart_items` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cart_item_colors_ibfk_2` FOREIGN KEY (`color_id`) REFERENCES `colors` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
('CUST-501', 'Juan', 'Dela Cruz', 'https://i.pravatar.cc/300?img=14', 'juan@example.com', 'active', 35, 'male', 'Juan\'s Sari-Sari', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', 15450.50, 12, NULL, NULL, '2024-05-12 14:20:00', '2026-03-27 11:00:00'),
('CUST-502', 'Laguna', 'Prints', 'https://i.pravatar.cc/300?img=15', 'info@lagunaprints.com', 'active', 42, 'female', 'Laguna Prints & Design', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 85200.00, 45, NULL, NULL, '2024-06-20 11:45:00', '2026-03-28 09:30:00');
...
INSERT INTO `customer_addresses` (`id`, `customer_id`, `full_name`, `phone`, `region`, `province`, `city`, `barangay`, `street`, `address`, `postal_code`, `is_default`, `latitude`, `longitude`) VALUES
('addr_002', 'CUST-501', 'Corporate Branch A', '+63 900 000 0000', 'Region IV-A', 'Laguna', 'Binan', 'San Pedro', 'Industrial Ave', 'Industrial Ave, Binan, Laguna', '4024', 1, 14.3333000, 121.0833000);
...
(1, 'CUST-503', 'customer', 'banned@example.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'EMP-001', 'employee', 'Fraudulent transactions reported', '2026-04-11 18:07:15'),
(2, 'EMP-005', 'employee', 'fired@pixs.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'EMP-001', 'employee', 'Violation of company policy', '2026-04-11 18:07:15');
...
('EMP-001', 'Jason', 'G', 'https://i.pravatar.cc/300?img=11', 'jason@pixs.com', 'admin', 'active', 28, 'male', 'PIXS PRINTING SHOP', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 0.00, 850.00, 150.00, '2024-01-15 08:00:00', '2026-03-28 10:30:00'),
('EMP-002', 'Staff', 'A', 'https://i.pravatar.cc/300?img=12', 'staff_a@pixs.com', 'staff', 'active', 24, 'female', 'PIXS PRINTING SHOP', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 0.00, 600.00, 100.00, '2024-02-10 09:00:00', '2026-03-28 08:15:00'),
('EMP-003', 'Tech', 'B', 'https://i.pravatar.cc/300?img=13', 'tech_b@pixs.com', 'technician', 'active', 30, 'male', 'PIXS PRINTING SHOP', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 0.00, 750.00, 120.00, '2024-03-15 10:00:00', '2026-03-28 11:45:00'),
('EMP-004', 'Weld', 'C', 'https://i.pravatar.cc/300?img=15', 'weld_c@pixs.com', 'welder', 'active', 28, 'male', 'PIXS PRINTING SHOP', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 0.00, 800.00, 150.00, '2024-03-15 10:00:00', '2026-03-28 11:45:00');
