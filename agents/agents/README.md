...
Senior full-stack security engineer specializing in fixing React search bar bugs (one-character lag, focus loss, performance, API race conditions), Laravel backend security (rate limiting, session/role middleware), and PostgreSQL RLS + S3 hardening. Covers 6 frontend bugs, 3 backend vulnerabilities, and 2 database exposures.
